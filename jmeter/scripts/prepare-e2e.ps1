...
param(
    [int]$PvtSenders = 500,
    [int]$PvtReceivers = 200,
    [int]$GrpSenders = 50,
    [int]$GrpReceivers = 100,
...
Write-Host "  pwsh run.ps1 -Plan 04-private-e2e -Threads 700 -Duration 90 -ExtraArgs `"-JsendThreads=500 -JrecvThreads=200 -JsendDelayMs=50 -JwarmupMs=10000 -JrecvDuration=120 -JdrainSec=30`""
Write-Host "  pwsh run.ps1 -Plan 05-group-e2e -Threads 150 -Duration 90 -ExtraArgs `"-JsendThreads=50 -JrecvThreads=100 -JsendDelayMs=500 -JwarmupMs=10000 -JrecvDuration=120 -JdrainSec=30`""
